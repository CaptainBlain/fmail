...
public class DatabaseController: NSObject {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "fmail-db")
...
extension DatabaseController {
    ...
    var userId: String {
        get {
            return User.getUser(context: self.persistentContainer.viewContext)?.identifier ?? ""
        }
    }
    ...
    func addUser() -> User {
        ...
        return NSEntityDescription.insertNewObject(forEntityName: Table.User, into: context) as! User
    }
